...
class PianoTiles:
    def __init__(self):
        ...
        print("Coordonatele jocului sunt",
              self.left_x, self.right_x, self.center_y)

    def _mouse_pos(self, border):
        print(
            f'Pune cursorul in {border} marginii ferestrei jocului si apasa ENTER')
        x, y = 0, 0
    ...
    def run(self, *, tile_rgb=10 or mycolor):
